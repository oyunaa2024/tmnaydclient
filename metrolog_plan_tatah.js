...
const init = async () => {
    ...
    const res = await db_metrolog.sequelize.query(`
                select * from MetDeps
                where ParentID = 0 and DepCOde NOT LIKE '-'`, {
        type: QueryTypes.SELECT,
    });

    for (let i = 0; i < res.length; i++) {
        const result = await db_metrolog.sequelize.query(`
            exec _sp_2019plan_report_hh_2_2 @depId=${res[i].ID}, @god=2025`, {
            type: QueryTypes.SELECT,
        });
        ...
        if (result.length) {
            ...
            for (k = 0; k < result.length; k++) {
                await db_test.sequelize.query(`
                        INSERT INTO Metrolog_Plan_2025 (f1 ,f2, f3, f4, f5, f6, f7, f8, f9, f10, 
                                        ...
                                        f21, f22, f23, f24, f25, f26, f27, f28, f29, f30)
                        VALUES (
                        ${result[k].f1 == null ? null : `N'${result[k].f1}'`}, 
                        ${result[k].f2 == null ? null : `N'${result[k].f2}'`}, 
                        ${result[k].f3 == null ? null : `N'${result[k].f3}'`}, 
                        ${result[k].f4 == null ? null : `N'${result[k].f4}'`}, 
                        ${result[k].f5 == null ? null : `N'${result[k].f5}'`}, 
                        ${result[k].f6 == null ? null : `N'${result[k].f6}'`}, 
                        ${result[k].f7 == null ? null : `N'${result[k].f7}'`}, 
                        ${result[k].f8 == null ? null : `N'${result[k].f8}'`}, 
                        ${result[k].f9 == null ? null : `N'${result[k].f9}'`}, 
                        ${result[k].f10 == null ? null : `N'${result[k].f10}'`}, 
                        ${result[k].f11 == null ? null : `N'${result[k].f11}'`}, 
                        ${result[k].f12 == null ? null : `N'${result[k].f12}'`}, 
                        ${result[k].f13 == null ? null : `N'${result[k].f13}'`}, 
                        ${result[k].f14 == null ? null : `N'${result[k].f14}'`}, 
                        ${result[k].f15 == null ? null : `N'${result[k].f15}'`}, 
                        ${result[k].f16 == null ? null : `N'${result[k].f16}'`}, 
                        ${result[k].f17 == null ? null : `N'${result[k].f17}'`}, 
                        ${result[k].f18 == null ? null : `N'${result[k].f18}'`}, 
                        ${result[k].f19 == null ? null : `N'${result[k].f19}'`}, 
                        ${result[k].f20 == null ? null : `N'${result[k].f20}'`}, 
                        ${result[k].f21 == null ? null : `N'${result[k].f21}'`}, 
                        ${result[k].f22 == null ? null : `N'${result[k].f22}'`}, 
                        ${result[k].f23 == null ? null : `N'${result[k].f23}'`}, 
                        ${result[k].f24 == null ? null : `N'${result[k].f24}'`}, 
                        ${result[k].f25 == null ? null : `N'${result[k].f25}'`}, 
                        ${result[k].f26 == null ? null : `N'${result[k].f26}'`}, 
                        ${result[k].f27 == null ? null : `N'${result[k].f27}'`}, 
                        ${result[k].f28 == null ? null : `N'${result[k].f28}'`}, 
                        null, 
                        null
                        );`,
                    {
            ...
            console.log(result[0].f2, "INSERTED");
